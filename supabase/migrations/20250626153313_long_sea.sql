/*
  ...
  2. Security
    ...
    - Add policies for users to manage their own itineraries and items
...
DROP POLICY IF EXISTS "Public itinerary items are viewable by everyone" ON itinerary_items;
DROP POLICY IF EXISTS "Users can view their own itinerary items" ON itinerary_items;
DROP POLICY IF EXISTS "Users can insert their own itinerary items" ON itinerary_items;
DROP POLICY IF EXISTS "Users can update their own itinerary items" ON itinerary_items;
DROP POLICY IF EXISTS "Users can delete their own itinerary items" ON itinerary_items;
