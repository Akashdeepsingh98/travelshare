/*
  ...
  1. New Tables
    ...
    - `guide_content_items` - Links posts and itineraries to travel guides
  
  2. Security
    - Enable RLS on both tables
    - Add policies for viewing, creating, updating, and deleting
    - Ensure public guides are viewable by everyone
    - Ensure users can only manage their own guides
...
-- RLS Policies for travel_guides - Using DO blocks with EXECUTE format
