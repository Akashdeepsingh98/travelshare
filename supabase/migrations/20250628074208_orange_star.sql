/*
  ...
  1. New Tables
    - `group_chats`
      ...
      - `last_message_id` (uuid, references group_messages)
    - `group_members`
      - `id` (uuid, primary key)
      - `group_chat_id` (uuid, references group_chats)
      - `user_id` (uuid, references profiles)
      - `role` (text, check constraint for 'member' or 'admin')
      - `joined_at` (timestamp)
    - `group_messages`
      - `id` (uuid, primary key)
      - `group_chat_id` (uuid, references group_chats)
      ...
      - `shared_post_id` (uuid, references posts, nullable)
      - `created_at` (timestamp)
  ...
  3. Changes
    - Add trigger to update group_chats.updated_at and last_message_id
*/
